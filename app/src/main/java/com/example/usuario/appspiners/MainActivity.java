package com.example.usuario.appspiners;
...
public class MainActivity extends Activity implements OnItemSelectedListener {
    ...
    private void loadSpinnerProvincias() {
        ...
        // Create an ArrayAdapter usando el  string array y un  spinner
        // layout
        ArrayAdapter<CharSequence> adapter = ArrayAdapter.createFromResource(
                this, R.array.provincias, android.R.layout.simple_spinner_item);
        // specifica el layot para su uso cuando la lista de opciones aparesca
        adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        // aplicamos el adapter to the spinner
        this.spProvincias.setAdapter(adapter);

        // Implementamos las actividades para el AdapterView.OnItemSelectedListener
